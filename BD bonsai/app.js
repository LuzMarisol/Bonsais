...
$('form').submit(function(e){
    ...
    let idFirebase = id;
    if(idFirebase==''){
        idFirebase = coleccionBonsais.push().key;
    };
    data = {codigo:codigo, especie:especie, nombreCientifico:nombreCientifico, nombreComun:nombreComun, edad:edad, estilo:estilo, precio:precio, cultivo:cultivo, maceta:maceta, riego:riego,trasplante:trasplante, lugar:lugar, cantidad:cantidad, tipo:tipo}
